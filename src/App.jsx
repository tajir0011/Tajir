    ...
    <div style={{ fontFamily: "'Segoe UI', Arial, sans-serif", margin: 0, padding: 0, color: DARK }}>
      ...
      <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: isMobile ? "16px 20px" : "20px 60px", background: "white", boxShadow: "0 1px 0 #ede9fe" }}>
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
          <button onClick={() => setPage("login")} style={{ padding: isMobile ? "7px 14px" : "8px 20px", background: "transparent", border: `2px solid ${PURPLE}`, color: PURPLE, borderRadius: "8px", cursor: "pointer", fontWeight: "600", fontSize: "14px" }}>Login</button>
          <button onClick={() => setPage("signup")} style={{ padding: isMobile ? "7px 14px" : "8px 20px", background: CORAL, border: "none", color: "white", borderRadius: "8px", cursor: "pointer", fontWeight: "600", fontSize: "14px" }}>Get Started</button>
        </div>
      </nav>
      ...
      <div style={{ padding: isMobile ? "40px 24px" : "80px 60px", background: DARK, textAlign: "center" }}>
        ...
        <p style={{ color: "#aaa", fontSize: isMobile ? "15px" : "18px", marginBottom: "40px" }}>Join thousands of merchants selling smarter with Tajir</p>
      ...
      <div style={{ padding: isMobile ? "24px 20px" : "32px 60px", background: "#1a1530", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "8px" }}>
        <span style={{ color: "#666", fontSize: "13px" }}>© 2026 Tajir. All rights reserved.</span>
        <span style={{ color: "#666", fontSize: "13px" }}>Built with ❤️ for Arab merchants</span>
      </div>
